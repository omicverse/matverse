...
@register_function(
    ...
    produces={"obs": ["coordination_number", "mean_neighbour_distance",
...
@register_function(
    ...
    description="Classify each atom's coordination polyhedron — octahedral, "
                ...
                "good the match is.",
    requires={"structures": ["{source}"]},
    produces={"obs": ["environment", "environment_csm",
...
@register_function(
    ...
    requires={"obs": ["coordination_number"]},
    produces={"obs": ["mean_coordination", "min_coordination",
